namespace BlacksmithWorkshopView
{
	partial class FormFillStorage
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelBillets = new System.Windows.Forms.Label();
			...
			// labelBillets
			// 
			this.labelBillets.AutoSize = true;
			this.labelBillets.Location = new System.Drawing.Point(11, 40);
			this.labelBillets.Margin = new System.Windows.Forms.Padding(2, 0, 2, 0);
			this.labelBillets.Name = "labelBillets";
			this.labelBillets.Size = new System.Drawing.Size(49, 13);
			this.labelBillets.TabIndex = 7;
			this.labelBillets.Text = "Заготовка";
			// 
			// labelStorage
			// 
			...
			this.comboBoxBillets.Location = new System.Drawing.Point(132, 40);
			this.comboBoxBillets.Margin = new System.Windows.Forms.Padding(2);
			this.comboBoxBillets.Name = "comboBoxBillets";
			this.comboBoxBillets.Size = new System.Drawing.Size(141, 21);
			this.comboBoxBillets.TabIndex = 5;
			// 
			// comboBoxStorage
			// 
			...
			this.Controls.Add(this.labelBillets);
		...
		private System.Windows.Forms.Label labelBillets;
