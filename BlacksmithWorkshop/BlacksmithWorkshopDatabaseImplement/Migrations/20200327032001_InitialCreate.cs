    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoodsBillets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GoodsBillets_Billetss_BilletsId",
                        column: x => x.BilletsId,
                        principalTable: "Billetss",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GoodsBillets_Goodss_GoodsId",
                        column: x => x.GoodsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GoodsBillets_BilletsId",
                table: "GoodsBillets",
                column: "BilletsId");

            migrationBuilder.CreateIndex(
                name: "IX_GoodsBillets_GoodsId",
                table: "GoodsBillets",
                column: "GoodsId");
